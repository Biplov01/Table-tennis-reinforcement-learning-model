# -*- coding: utf-8 -*-
"""
Created on Sun Feb  4 09:04:37 2024
...
def draw_game_objects():
    screen.fill((153, 76, 0))  # Brown color for the background

    # Draw green oval shapes as paddles (tennis rackets)
    pygame.draw.ellipse(screen, (255, 255, 255), pygame.Rect(0, paddle1_y, 20, 100))
    pygame.draw.ellipse(screen, (255, 255, 255), pygame.Rect(580, paddle2_y, 20, 100))

    # Draw handles for the rackets
    pygame.draw.line(screen, (255, 255, 255), (10, paddle1_y + 50), (10, paddle1_y + 50 + 20), 5)
    pygame.draw.line(screen, (255, 255, 255), (590, paddle2_y + 50), (590, paddle2_y + 50 + 20), 5)

    # Draw vertical sticks with the diameter of the oval shapes
    pygame.draw.line(screen, (255, 255, 255), (10, paddle1_y + 50), (10, paddle1_y + 150), 5)
    pygame.draw.line(screen, (255, 255, 255), (590, paddle2_y + 50), (590, paddle2_y + 150), 5)

    # Draw a yellow circle as a tennis ball
    pygame.draw.circle(screen, (255, 255, 0), (int(ball_x), int(ball_y)), 10)
...
while True:
    ...
    # get a new state and update Q-value
    new_state = (int(ball_x / 10) - int(paddle1_y / 10), int(ball_y / 10), int(paddle2_y / 10), int(ball_dx / abs(ball_dx)), int(ball_dy / abs(ball_dy)))

    # ensure the new state is initialized in q_table
